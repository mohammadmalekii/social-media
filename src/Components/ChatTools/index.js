                ...
                <>
                    ...
                    <div dir='rtl' className={`${showDropDown && report ? "bg-white dark:bg-zinc-700 dark:text-white left-[38%] top-[40%] fixed w-[28rem] h-32 rounded-lg pt-4 pr-5 scale-100 opacity-100" : "opacity-0 scale-0"}`}>
                        ...
                        <div className="flex justify-end items-center w-full space-x-4 mt-10">
                            <button onClick={() => setReport(false)} className="ease-in-out duration-200 px-3 py-2 rounded-xl hover:bg-zinc-800/10 dark:hover:bg-blue-200/10">لغو</button>
            ...
            {showDropDown && exit
                ...
                <>
                    ...
                    <div dir='rtl' className={`${showDropDown && exit ? "bg-white dark:bg-zinc-700 dark:text-white left-[38%] top-[40%] fixed w-[28rem] h-32 rounded-lg pt-4 pr-5 scale-100 opacity-100" : "opacity-0 scale-0"}`}>
                        ...
                        <div className="flex justify-end items-center w-full space-x-4 mt-10">
                            <button onClick={() => setExit(false)} className="ease-in-out duration-200 px-3 py-2 rounded-xl hover:bg-zinc-800/10 dark:hover:bg-blue-200/10">لغو</button>
