...
const SearchBar = () => {
  ...
  return (
    <div className="flex justify-center items-center border-b-2 border-zinc-900">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 absolute top-[85px] left-[9%] text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
