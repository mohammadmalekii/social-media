const NewContact = ({setShowContact,closeSidebar}) => {
...
<div className="flex z-50 w-full h-full justify-center items-center ease-in-out duration-500 show">
    <form className="bg-white dark:bg-zinc-800 z-50 w-96 p-6 dark:text-white rounded-xl flex flex-col justify-center items-center space-y-10">
      ...
      <div dir="rtl" className="relative z-0 w-full mb-6 group">
        ...
        <div className="flex justify-end items-center w-full space-x-4 mt-10">
            <button onClick={handleContactForm} className="ease-in-out duration-200 px-3 py-2 rounded-xl hover:bg-zinc-800/10 dark:hover:bg-blue-200/10">لغو</button>
