...
const Setting = ({ setShowSetting, setShowSidebar }) => {
  ...
  return (
    <div dir='rtl' className="flex z-50 w-full h-full justify-center items-center ease-in-out duration-500 show">
      <div className="bg-zinc-800 text-white w-[26%] rounded-xl flex flex-col justify-center items-center space-y-3 py-4 px-6">

        <div className="flex items-center justify-between w-full pb-3">
          <h1>تنظیمات</h1>
          <svg onClick={handleSettingForm} xmlns="http://www.w3.org/2000/svg" className="h-[35px] w-[35px] cursor-pointer hover:bg-zinc-700 active:bg-zinc-600 transition-color duration-300  p-2 rounded-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <ul className="flex flex-col w-full">
          ...
          <li className="flex items-center py-3.5 hover:bg-slate-700 hover:pr-3 ease-in-out duration-300 cursor-pointer rounded-2xl">
